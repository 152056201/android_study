...
public class DatabasesProvider extends ContentProvider {
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (uriMatcher.match(uri)){
            ...
            case BOOK_ITEM:
                ...
                deleteRows = database.delete("Book","id=?",new String[]{newBookId});
                break;
            case CATEGORY_DIR:
            ...
            case CATEGORY_ITEM:
                ...
                deleteRows = database.delete("Category","id=?",new String[]{newCategoryId});
                break;
            default:
                break;
        }
    ...
    public boolean onCreate() {
        ...
        dataBaseHelper = new MyDataBaseHelper(getContext(), "Book.db", null, 2);
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        switch (uriMatcher.match(uri)) {
            ...
            case CATEGORY_ITEM:
                String newCategoryId = uri.getPathSegments().get(1);
                updateRows = database.update("Category", values, "id=?", new String[]{newCategoryId});
                break;
            default:
                break;
        }
